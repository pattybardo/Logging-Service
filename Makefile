...
UnitTest: UnitTestLoggingService.cpp LoggingClient.cpp LoggingService.cpp
	g++ -std=c++17 UnitTest.cpp UnitTestLoggingService.cpp LoggingClient.cpp LoggingService.cpp Log.cpp -o UnitTest -L/usr/local/Cellar/boost/1.72.0/lib/ -lboost_serialization
